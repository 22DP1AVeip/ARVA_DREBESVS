...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall title="Paroles maiņa" description="Pārliecinies, ka tavā kontā ir droša, gara parole" />
                ...
                <form @submit.prevent="updatePassword" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="form.processing">Saglabāt paroli</Button>
