...
<template>
    <div class="min-h-screen flex flex-col justify-center items-center bg-white px-4 py-8">
        ...
        <div class="w-full max-w-md bg-white p-8 rounded shadow-md">
            <h1 class="text-2xl font-bold mb-2 text-center text-black">Ienāc savā kontā</h1>
            <p class="text-sm text-center text-gray-700 mb-6">Ievadi savu e-pastu un paroli, lai ienāktu</p>
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="password" type="password" required :tabindex="2" autocomplete="current-password" v-model="form.password" placeholder="Parole" class="text-white" />
                    <InputError :message="form.errors.password" />
                </div>

                <div class="flex items-center gap-2" :tabindex="3">
                    <Checkbox id="remember" v-model:checked="form.remember" :tabindex="4" />
                    <Label for="remember" class="text-black">Atcerēties mani</Label>
                </div>
            ...
            <div class="text-center text-sm text-gray-700 mt-4">
                Nav konta?
                <TextLink :href="route('register')" class="text-black font-semibold underline underline-offset-4" :tabindex="5">Reģistrēties</TextLink>
            </div>
        </div>
    </div>
</template>
